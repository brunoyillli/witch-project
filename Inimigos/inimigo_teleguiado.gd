...
var alma_azul = load("res://Cristais/Alma_Azul/alma_azul.tscn")
var alma_rosa = load("res://Cristais/Alma_Rosa/alma_rosa.tscn")
var alma_verde = load("res://Cristais/Alma_verde/alma_verde.tscn")
